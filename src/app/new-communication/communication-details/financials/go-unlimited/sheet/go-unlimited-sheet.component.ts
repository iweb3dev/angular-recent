...
@Component({
  selector: 'app-go-unlimited-sheet',
  templateUrl: './go-unlimited-sheet.component.html',
  styleUrls: ['./go-unlimited-sheet.component.scss'],
})
export class GoUnlimitedSheetComponent implements OnInit {
  ...
  constructor(
    ...
    private _bottomSheetRef: MatBottomSheetRef<GoUnlimitedSheetComponent>,
