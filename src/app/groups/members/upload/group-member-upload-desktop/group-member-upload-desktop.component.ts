...
@Component({
  selector: 'app-group-member-upload-desktop',
  templateUrl: './group-member-upload-desktop.component.html',
  styleUrls: ['./group-member-upload-desktop.component.scss'],
})
export class GroupMemberUploadDesktopComponent {
