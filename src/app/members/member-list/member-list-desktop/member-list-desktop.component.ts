...
@Component({
  selector: 'app-member-list-desktop',
  templateUrl: './member-list-desktop.component.html',
  styleUrls: ['./member-list-desktop.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MemberListDesktopComponent implements OnChanges {
