...
@Component({
  selector: 'app-call-in-dialog',
  templateUrl: './call-in-dialog.component.html',
  styleUrls: ['./call-in-dialog.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CallInDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private _dialogRef: MatDialogRef<CallInDialogComponent>,
